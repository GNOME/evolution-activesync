...
gboolean eas_sync_req_Activate (EasSyncReq *self, const gchar* syncKey, const gchar* accountID, EFlag *flag, const gchar* folderId, EasItemType type, GError** error);
