...
gboolean eas_delete_email_req_Activate (EasDeleteEmailReq *self, GError** error);
gboolean eas_delete_email_req_ActivateFinish (EasDeleteEmailReq* self, gchar** ret_sync_key, GError** error);
