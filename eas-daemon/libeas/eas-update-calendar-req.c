...
EasUpdateCalendarReq *eas_update_calendar_req_new(guint64 account_id, const gchar *sync_key, const EasItemType item_type, const gchar *folder_id, const GSList* serialised_calendar, EFlag *flag)
{
