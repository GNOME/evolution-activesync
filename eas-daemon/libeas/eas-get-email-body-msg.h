...
EasGetEmailBodyMsg* eas_get_email_body_msg_new (const gchar* serverUid, const gchar* collectionId, const gchar* directoryPath);
xmlDoc* eas_get_email_body_msg_build_message (EasGetEmailBodyMsg* self);
gboolean eas_get_email_body_msg_parse_response (EasGetEmailBodyMsg* self, xmlDoc* doc, GError** error);
