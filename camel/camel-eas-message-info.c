			...
			CamelFolderSummary *assign_summary)
{
	...
	if (CAMEL_IS_EAS_MESSAGE_INFO (result)) {
		...
		camel_eas_message_info_set_server_flags (emi_result, camel_eas_message_info_get_server_flags (emi));
		camel_eas_message_info_set_item_type (emi_result, camel_eas_message_info_get_item_type (emi));
		camel_eas_message_info_take_change_key (emi_result, camel_eas_message_info_dup_change_key (emi));
	}
